...
* *https://nodeca.github.io/pica/demo/[pica]* - high quality and fast image
resize in browser.
* *https://github.com/nodeca/babelfish/[babelfish]* - developer friendly
...
image:https://octodex.github.com/images/stormtroopocat.jpg[Stormtroopocat]
...
https://www.npmjs.org/browse/keyword/markdown-it-plugin[syntax plugins].
...
Footnote 1 linkfootnote:first[Footnote *can have markup*
